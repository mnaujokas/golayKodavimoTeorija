...
import lt.golay.config.audit.AuditEventConverter;
import lt.golay.domain.PersistentAuditEvent;
...
import static lt.golay.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
