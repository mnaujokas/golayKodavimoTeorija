...
describe('Service Tests', () => {
  describe('Vector Service', () => {
    ...
    beforeEach(() => {
      ...
      expectedResult = {};
      injector = getTestBed();
      service = injector.get(VectorService);
      httpMock = injector.get(HttpTestingController);

      elemDefault = new Vector(0, 'AAAAAAA', 'AAAAAAA', 'AAAAAAA', 'AAAAAAA', 0, 'AAAAAAA');
    });
    ...
    describe('Service methods', () => {
      ...
      it('should return a list of Vector', () => {
        const returnedFromService = Object.assign(
          {
            data: 'BBBBBB',
            encoded: 'BBBBBB',
